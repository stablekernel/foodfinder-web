<div class="full-wdith">
    <div class="desktop-bg">
        <div class="login-bg">
            <div class="schoolresultmap_page">               <?php $url_link = $this->uri->segment(2);
                if ($url_link == 'homeway') {
                    $link = 'homeway';
                } else {
                    $link = 'locationway';
                } ?>
                <div class="back_icon"><a href="<?php echo base_url(); ?>school/<?php echo $link; ?>"
                                          style="cursor:pointer"><img src="<?php echo base_url(); ?>img/front/close.png"
                ...
                <div class="schoolresult_map clearfix">
                    <form action="<?php echo site_url(); ?>school/homeway" method="post" class="schoolform"><input
                            type="hidden" value="<?php echo $this->session->userdata('searchedhome'); ?>" class="n1"
                            name="homeaddress"/></form> <?php echo $map['js']; ?>            <?php echo $map['html']; ?>
                    <div class="radius_wrap">
                        <div class="radius_wrap_left"></div>
                        <div class="radius_wrap_right">
                            <form action="" method="post" class=""> Radius&nbsp;&nbsp;&nbsp;<input type="text" value="5"
                                ...
                                <input type="hidden" value="<?php echo $latit ?>" id="latit" name="latit"/> <input
                                    ...
                                    type="hidden" value="" id="search_data" name="search_data"/></form>
                        </div>
...
<script>$(document).ready(function () {
        ...
        $("#map_radius").keypress(function (event) {
            ...
            if (keycode == 13) {
                ...
                var formdata = {"radius": radius_data, "latit": latit, "longit": longit};
                $.ajax({
                    url: '<?php echo site_url();?>school/locationway_radius',
                    data: formdata,
                    type: 'POST',
    ...
    function initialize(res) {
        ...
        var marker = new google.maps.Marker({position: myLatlng, map: map, title: cname, icon: image});

				...
				<div class="span9">
					...
					<fieldset>
					    <div class="control-group">
					      ...
					      <div class="controls">
					        <input type="text" class="input-large" name="schoolname" maxlength="100" id="schoolname">
					      </div>
					    </div>
					    <div class="control-group">
					      <label class="control-label" for="supplier_name">School Address1 <Mandatory>*</Mandatory></label>
					      <div class="controls">
					        <input type="text" class="input-large" name="schooladdress1" id="schooladdress1" maxlength="100">
					      </div>
					    </div>
					    <div class="control-group">
					      <label class="control-label" for="name">School Address2</label>
					      <div class="controls">
					        <input type="text" class="input-large" name="schooladdress2" id="schooladdress2" maxlength="100">
					      </div>
					    </div>
					    <div class="control-group">

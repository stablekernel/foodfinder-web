  ...
  <thead>
	...
	<tbody>
		...
		<tr id="row<?php echo $schooldetails[$t]["school_id"];?>">
			...
			<td align="left" valign="middle"><?php echo $schooldetails[$t]["school_address1"]."<br>".$schooldetails[$t]["school_address2"]; ?></td>
			...
			<td align="center"><a href="<?php echo site_url();?>admin/schooledit/<?php echo $schooldetails[$t]["school_id"];?>" class='custedit' rel='tooltip' title='Click here to Edit'> </a></td>
          <td align="center"><a href='javascript:void(0);' rel='tooltip' class='school-delete custdeactiveie' title="Click here to delete" id="<?php echo $schooldetails[$t]["school_id"];?>"> </a></td>
		</tr>
		<?php } ?>
	</tbody>
</table>
...
$(document).ready(function() {
    $(".school-delete").click(function() {
		...
		if(answer==false) { return false; }
			...
			function(data) { id = "row" + uid; $("tr").each(function(){ window.location.href = "<?php echo site_url();?>admin/manageschool"; });
	   });
	});

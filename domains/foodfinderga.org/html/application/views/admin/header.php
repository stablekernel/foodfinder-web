...
<head>
    ...
    <script src="<?php echo base_url();?>js/libs/jquery-1.7.2.min.js" type="text/javascript" language="javascript"></script>    
...
<div id="header">	
	<div class="container">
    	<div style="float:left; width:350px; padding-top:20px;"><a href="<?php echo site_url('admin/dashboard'); ?>" style="color:#fff; text-decoration:none;"><h1>Food Finder GA</h1></a></div>
		<div class="nav-collapse" style="padding-top:32px;">
			<ul id="main-nav" class="nav pull-right">
				<li class="nav-icon <?php if($pageName=="dashboard") { echo "active"; } ?>">
					<a href="<?php echo site_url('admin/dashboard'); ?>">
						<i class="icon-home"></i>
						<span>Home</span>        					
					</a>
				</li>
				<li class="dropdown <?php if($pageName=="addschool" or $pageName=="manageschool") { echo "active"; } ?>">
				...
				<li class="dropdown <?php if($pageName=="addprovider" or $pageName=="manageprovider") { echo "active"; } ?>">
					<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
						<i class="icon-user"></i>
						<span>Provider</span> 
						<b class="caret"></b>
				...
				<li class="dropdown" <?php if($pageName=="changepassword") { echo "active"; } ?>">
					<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
						<i class="icon-user"></i>

...
<div class="container">
	...
	<div align="left" style="font-size:14px; font-weight:bold;">RK INTERNATIONAL SERVICES PVT LTD</div>
    <div style="clear:both; height:10px;"><!-- --></div>
	<div align="left" style="font-size:14px; font-weight:bold;">MATERIALS DETAILS - <?php if(isset($selectedgroup)) { for($t=0;$t<count($selectedgroup);$t++) { echo $group[$t]["groupname"]." "; } } else { echo "All GROUPS"; }?></div>
    <div style="clear:both; height:10px;"><!-- --></div>
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered datagrid">
        <thead>
        <tr>
        	<th>SLNO</th>
        ...
        <tr>
			...
			<td align="left" valign="middle"><?php echo strtoupper($members[$t]["units"]); ?></td>
		</tr>
		<?php } ?>
        </tbody>
	</table>
...
<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered datagrid" id="schooltable" style="width:100%">
  <thead>
		<tr>
	...
	<tbody>
		...
		<tr id="row<?php echo $providerdetails[$t]["provider_id"];?>">
        	<td align="left" valign="middle"><?php echo $t+1; ?></td>        
			<td align="left" valign="middle"><?php echo $providerdetails[$t]["providername"]; ?></td>
			<td align="left" valign="middle"><?php echo $providerdetails[$t]["streetaddress1"]."<br>".$providerdetails[$t]["streetaddress2"];?></td>
			...
			<td align="left" valign="middle"><?php echo $providerdetails[$t]["contactperson"]; ?></td>
			<td align="left" valign="middle"><?php echo $providerdetails[$t]["operatingdays"]." ".$providerdetails[$t]["operatinghours"]; ?></td>
			<td align="left" valign="middle"><?php echo $providerdetails[$t]["servicearea"]; ?></td>
			<td align="center"><a href="<?php echo site_url();?>admin/provideredit/<?php echo $providerdetails[$t]["provider_id"];?>" class='custedit' rel='tooltip' title='Click here to Edit'> </a></td>
          <td align="center"><a href='javascript:void(0);' rel='tooltip' class='provider-delete custdeactiveie' title="Click here to delete" id="<?php echo $providerdetails[$t]["provider_id"];?>"> </a></td>
		</tr>
		<?php } ?>
	</tbody>
</table>
...
$(document).ready(function() {
    $(".provider-delete").click(function() {
		...
		if(answer==false) { return false; }
			...
			function(data) { id = "row" + uid; $("tr").each(function(){ window.location.href = "<?php echo site_url();?>admin/manageprovider"; });
	   });
	});

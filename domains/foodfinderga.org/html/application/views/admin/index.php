...
<div class="account-container login stacked">
	<div class="content clearfix">		
        <div align="center">
         ...
         <div id="infoMessage" class="alert alert-warning"><button type="button" class="close" data-dismiss="alert">&times;</button><?php echo $this->session->flashdata('loginstatus');?></div>
         <?php endif;?>
		<form id="addgroup-form" method="post" novalidate='novalidate' class='validate' accept-charset="utf-8">
			...
			<div class="login-fields">				
				<div class="field controls control-group">
					...
					<input type="text" id="email" name="email" value="" placeholder="E-Mail ID" class="login username-field" />
				</div> <!-- /field -->				
				<div class="field controls control-group">

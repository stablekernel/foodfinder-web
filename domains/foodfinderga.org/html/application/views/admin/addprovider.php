				...
				<div class="span9">
					...
					<fieldset>
					    <div class="control-group">
					      ...
					      <div class="controls">
					        <input type="text" class="input-large" name="providername" maxlength="100" id="providername">
					      </div>
					    </div>
					    <div class="control-group">
					    ...
					    <div class="control-group">
                          ...
                          <option value="<?php echo $fields["state_code"]; ?>"><?php echo $fields["state"]; ?></option>
                          <?php } ?>
                          </select>
					      </div>
					    </div>
					    ...
					    <div class="control-group">
					      ...
					      <div class="controls">
					        <input type="text" class="input-large" name="county" id="county" maxlength="100" value="Gwinnett" />
					      </div>
					    </div>
					    <div class="control-group">
					    ...
					    <div class="control-group">
					      ...
					      <div class="controls">
					        <input type="text" class="input-large" name="contactperson" id="contactperson" maxlength="100">
					      </div>
					    </div>
					    <div class="control-group">
					      <label class="control-label" for="store">Operating Days</label>
					      <div class="controls">
					        <input type="text" class="input-large" name="operatingdays" id="operatingdays" maxlength="100">
					      </div>
					    </div>
					    <div class="control-group">
					      <label class="control-label" for="store">Operating Hours</label>
					      <div class="controls">
					        <input type="text" class="input-large" name="operatinghours" id="operatinghours" maxlength="100">
					      </div>
					    </div>
					    <div class="control-group">
					      <label class="control-label" for="store">Service Area</label>
					      <div class="controls">
					        <input type="text" class="input-large" name="servicearea" id="servicearea" maxlength="100">
					      </div>
					    </div>
					    <div class="control-group">
					      <label class="control-label" for="store">Languages</label>
					      <div class="controls">
					        <input type="text" class="input-large" name="languages" id="languages" maxlength="100">
					      </div>
					    </div>
					    <div class="control-group">
					      <label class="control-label" for="store">Services1</label>
					      <div class="controls">
					        <input type="text" class="input-large" name="services1" id="services1" maxlength="100">
					      </div>
					    </div>
					    <div class="control-group">
					      <label class="control-label" for="store">Services2</label>
					      <div class="controls">
					        <input type="text" class="input-large" name="services2" id="services2" maxlength="100">
					      </div>
					    </div>
					    <div class="control-group">
					      <label class="control-label" for="store">Services3</label>
					      <div class="controls">
					        <input type="text" class="input-large" name="services3" id="services3" maxlength="100">
					      </div>
					    </div>					    
					    <div class="form-actions">
					      <button type="submit" name="submit" id="submit" class="btn btn-primary btn-large">Add</button>
					    </div>
					  </fieldset>
					</form>
				</div><!-- /.span9 -->

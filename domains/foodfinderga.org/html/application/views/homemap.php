<div class="full-wdith">
    <div class="desktop-bg">
        <div class="login-bg">
            <div class="schoolresultmap_page" id="thamarai">                <?php $url_link = $this->uri->segment(2);
                if ($url_link == 'homeway') {
                    $link = 'homeway';
                } else {
                    $link = 'locationway';
                ...
                <!--                <div class="searchresult_title_map" align="center">Click to see more information on food resources.</div>-->
                <div class="schoolresult_map clearfix">
                    <form action="<?php echo site_url(); ?>school/homeway" method="post" class="schoolform"><input
                            ...
                            name="homeaddress"/> <input type="hidden" value="<?php echo $latit ?>" id="latit"
                                                        name="latit"/> <input type="hidden"
                                                                              value="<?php echo $longit ?>" id="longit"
                                                                              name="longit"/> <input type="hidden"

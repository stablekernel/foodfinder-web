...
<div id="fc-light" class="fc-white_content">
    <div id="fc-main" class="fc-main-box">
        ...
        </div><iframe id="fc-myFrame" height="580" width="925" style="frameborder: 0; " scrolling="no" src=""></iframe></div></div>
...
<div align="center" class="footer-text">&copy;<?php echo date('Y');?>
    ...
    <a href="https://twitter.com/FoodFinderGA" target="blank"><img src="<?php echo base_url(); ?>img/front/twitter_iconsm.png"/>
    </a>&nbsp;&nbsp;<a href="https://www.facebook.com/FoodFinderGA/" target="blank"><img src="<?php echo base_url(); ?>img/front/facebook_icon.png"/>

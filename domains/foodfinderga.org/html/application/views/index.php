    ...
    <div class="desktop-bg">
        <div class="login-bg">            
            ...
            <div class="footer-bg clearfix">
                <div align="center" class="homefont2">Click an icon to find food near your ...</div>                
...
<div id="img-grp-wrap">
			...
			<div class="slider_wrapper">
				<ul id="image_slider">
					<a href="<?php echo site_url('school'); ?>"><li><img src="<?php echo base_url(); ?>img/front/school_slider.png"></li></a>
					<a href="<?php echo site_url('school/homeway'); ?>"><li><img src="<?php echo base_url(); ?>img/front/home_slider.png"></li></a>
					<a href="<?php echo site_url('school/locationway'); ?>"><li><img src="<?php echo base_url(); ?>img/front/location_slider.png"></li></a>
				</ul>					
